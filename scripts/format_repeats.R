...
orth_chipseq_core = read.delim("//ATLAS/IIER_TumoresInfantiles/RESULTADOS LABORATORIO/PROYECTO LIPI/4-Datasets/Orth et al_ESCLA/Orth_et_al_Suppl2_Core-ChIPseq.txt", header= TRUE, sep = "\t", dec = ".") #load localization of Binding Sites for EF by ChIPseq from Orth et al, 2021
