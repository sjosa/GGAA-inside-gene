...
### load genes_datasets
genes_dataset = read.table("//ATLAS/IIER_TumoresInfantiles/RESULTADOS LABORATORIO/PROYECTO LIPI/4-Datasets//RNAseq AsiEF/A673_RNAseq_Laura.txt", header = TRUE, dec = ",") #load file by path. CHANGE PATH
